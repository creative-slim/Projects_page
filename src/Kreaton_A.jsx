...
export const Kreaton = forwardRef((props, ref) => {
  ...
  useEffect(() => {
    ...
    // Start the SIT_ARMCHAIR animation once
    const sitArmchairAction = actions["SIT_ARMCHAIR"];
    if (sitArmchairAction) {
      sitArmchairAction.reset().play();
    } else {
      console.warn('Animation "SIT_ARMCHAIR" not found');
    }
